...
import {createTool, GenerativeProvider, Message, OpenaiAssistant, System, User,} from "../../src/index.js";
...
test("should use tool", async () => {
  ...
  const app = (
    <GenerativeProvider>
      ...
      <OpenaiAssistant tools={[tool]} toolChoice={tool} />
    </GenerativeProvider>
  );
  const {} = render(app);
    ...
    const app = (
      <GenerativeProvider>
        ...
        <ErrorBoundary>
          ...
          <OpenaiAssistant clientOptions={{ apiKey: "deadbeef" }} />
        </ErrorBoundary>
      </GenerativeProvider>
    );
